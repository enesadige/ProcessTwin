...
def build_server(tools: NetworkMCPTools) -> Server:
    async def list_tools(_ctx, _params) -> types.ListToolsResult:
        return types.ListToolsResult(
            tools=[
                ...
                for definition in NETWORK_TOOL_DEFINITIONS.values()
            ]
        )
...
async def run_stdio() -> None:
    ...
    server = build_server(NetworkMCPTools(client))
