...
SERVER_NAME = "processtwin-customer"


def build_server(tools: CustomerMCPTools) -> Server:
    async def list_tools(_ctx, _params) -> types.ListToolsResult:
        return types.ListToolsResult(
            tools=[
                ...
                for definition in CUSTOMER_TOOL_DEFINITIONS.values()
            ]
        )
...
async def run_stdio() -> None:
    ...
    server = build_server(CustomerMCPTools(client))
